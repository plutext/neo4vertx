 ...
 */
public class ClusterDemoMasterVerticle extends AbstractDemoVerticle {
    ...
    public static void main(String[] args) throws IOException {
        deployVerticle(ClusterDemoMasterVerticle.class.getCanonicalName(), null);
        keepProcessAlive();
    }
    ...
    public void start() throws Exception {
        ...
        startNeo4Vertx("neo4vertx_cluster_master.json");
